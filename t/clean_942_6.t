...
is ( $record1->subfield( '942', '6' ), '_', '942$6 present' );

# Run the sub
Util::clean_942_6( $record1 );

# Show formatted record
# diag( $record1->as_formatted );

# Check record in Koha has expected data in what has now become the first 942 field
is ( $record1->subfield( '942', '6' ), undef, '942$6 removed' );
...
# Check record in Koha has expected data in the first 942 field
is ( $record2->subfield( '942', '6' ), '_', '942$6 present' );

# Run the sub
Util::clean_942_6( $record2 );

# Show formatted record
# diag( $record2->as_formatted );

# Check record in Koha has expected data in what has now become the first 942 field
is ( $record2->subfield( '942', '6' ), undef, '942$6 removed' );
